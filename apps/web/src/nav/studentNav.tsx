import type { NavItem } from './NavConfigContext';

// Student sidebar entries. Moved verbatim from components/Sidebar.tsx for
// the two-door split so each entry point injects only the nav its bundle
// serves (the student bundle must not carry teacher route strings).
